                    ...
                    buttons: [
                        {
                            ...
                            onClick: function (e) {
                                GetOpcion(2)
                                GetInputsUpdate(e.row.data['ID_MARCA_REPUESTO'], e.row.data['NOMBRE'], e.row.data['DESCRIPCION'])
                            }
                        },
                        {
                            visible: function (e) {
                            ...
                            icon: "clear",
                            onClick: function (e) {
                                Delete(e.row.data['ID_MARCA_REPUESTO'], 6)
                            }
                        }
                    ]
                },
    ...
    function Delete(id, tipo) {
        $.ajax({
            ...
            success: function (data) {
                var state = data["State"];
                if (state == 1) {
                    ShowAlertMessage('success', 'La marca de repuesto seleccionada se inactivó correctamente.')
                    GetDatos()
                }
                else if (state == -1) {
                    ShowAlertMessage('warning', data['Message'])
